...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\Conid{Warning}\mathrel{=}\Conid{StrongOverrun}\;\Conid{VTime}\mid \Conid{WeakOverrun}\;\Conid{VTime}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{data}\;\Conid{TemporalE}\;\Varid{a}\mathrel{=}\Conid{TE}\;(\Conid{VTime}\to \Conid{Temporal}\;(\Varid{a},[\mskip1.5mu \Conid{Warning}\mskip1.5mu])){}\<[E]%
\\[\blanklineskip]%
